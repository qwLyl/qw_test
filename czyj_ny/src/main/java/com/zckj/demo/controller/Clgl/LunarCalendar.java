...
public class LunarCalendar {
    public static void main(String[] args) {
        // 调用农历日期转换阳历日期方法
        String str = new Calendar().sCalendarLundarToSolar(2020, 1, 1);
    ...
    static class Calendar {
        ...
        String sCalendarSolarToLundar(int iYear, int iMonth, int iDay) {
        ...
        String sCalendarLundarToSolar(int iYear, int iMonth, int iDay) {
    ...
    class Week {
        ...
        public Week(int w) {
            if ((w > 6) || (w < 0)) {
                System.out
                        .println(" Week out of range, I think you want Sunday ");
                this.iWeek = 0;
            } else
                this.iWeek = w;
        }
    ...
    class SolarDate extends MyDate {
        private int checkMonth(int iMonth) {
            if (iMonth > 12) {
                System.out
                        .println(" Month out of range, I think you want 12 :) ");
                return 12;
            } else if (iMonth < 1) {
                System.out
                        .println(" Month out of range, I think you want 1 :) ");
                return 1;
            } else
                return iMonth;
        }

        private int checkDay(int iYear, int iMonth, int iDay) {
            int iMonthDays = new Calendar().iGetSYearMonthDays(iYear, iMonth);
        ...
        public Week toWeek() {
            ...
            for (int i = 1901; i < iYear; i++) {
                if (new Calendar().bIsSolarLeapYear(i))
                    iOffsetDays += 366;
                else
                    iOffsetDays += 365;
            }

            iOffsetDays += new Calendar().iGetSNewYearOffsetDays(iYear, iMonth,
                    iDay);
        ...
        public LunarDate toLunarDate() {
            ...
            LunarDate ld;
            iDate = Integer.parseInt(new Calendar().sCalendarSolarToLundar(
    ...
    class LunarDate extends MyDate {
        private String sChineseNum[] = { " 零 ", " 一 ", " 二 ", " 三 ", " 四 ",
                " 五 ", " 六 ", " 七 ", " 八 ", " 九 ", " 十 " };

        private int checkMonth(int iYear, int iMonth) {
            if ((iMonth > 12)
                    && (iMonth == new Calendar().iGetLLeapMonth(iYear) + 12)) {
                return iMonth;
            } else if (iMonth > 12) {
                System.out
                        .println(" Month out of range, I think you want 12 :) ");
        ...
        private int checkDay(int iYear, int iMonth, int iDay) {
            int iMonthDays = new Calendar().iGetLMonthDays(iYear, iMonth);
        ...
        public CnWeek toWeek() {
            int iOffsetDays = 0;
            for (int i = 1901; i < iYear; i++)
                iOffsetDays += new Calendar().iGetLYearDays(i);

            iOffsetDays += new Calendar().iGetLNewYearOffsetDays(iYear, iMonth,
                    iDay);
        ...
        public SolarDate toSolarDate() {
            int iYear, iMonth, iDay, iDate;
            SolarDate sd;
            iDate = Integer.parseInt(new Calendar().sCalendarLundarToSolar(
                    this.iYear, this.iMonth, this.iDay));
            iYear = iDate / 10000;
            iMonth = iDate % 10000 / 100;
            iDay = iDate % 100;
    ...
    class ChineseEra {
        int iYear;
        String[] sHeavenlyStems = { " 甲 ", " 乙 ", " 丙 ", " 丁 ", " 戊 ", " 己 ",
                " 庚 ", " 辛 ", " 壬 ", " 癸 " };
        String[] sEarthlyBranches = { " 子 ", " 丑 ", " 寅 ", " 卯 ", " 辰 ", " 巳 ",
                " 午 ", " 未 ", " 申 ", " 酉 ", " 戌 ", " 亥 " };
