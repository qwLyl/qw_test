 ...
 (function ( global, factory ) {
	...
	var canvg = function (target, s, opts) {
		...
		if (target == null && s == null && opts == null) {
			...
			for (var i=0; i<svgTags.length; i++) {
				...
				svgTag.super_org_node.insertBefore(c, svgTag);
				svgTag.super_org_node.removeChild(svgTag);
	...
	function build(opts) {
		...
		svg.loadXmlDoc = function(ctx, dom) {
			...
			var draw = function() {
				svg.ViewPort.Clear();
				if (ctx.canvas.super_org_node) svg.ViewPort.SetCurrent(ctx.canvas.super_org_node.clientWidth, ctx.canvas.super_org_node.clientHeight);
