        ...
        Highcharts.Chart.prototype.getSVGForLocalExport = function(options, chartOptions, failCallback, successCallback) {
            var chart = this,
                ...
                embeddedSuccess = function(imageURL, imageType, callbackArgs) {
                    ...
                    callbackArgs.imageElement.setAttributeNS('http://www.w3.org/09/xlink', 'href', imageURL);
            ...
            try {
                ...
                for (i = 0, l = images.length; i < l; ++i) {
                    el = images[i];
                    Highcharts.imageToDataUrl(el.getAttributeNS('http://www.w3.org/09/xlink', 'href'), 'image/png', {
                            imageElement: el
                        }, options.scale,
                        embeddedSuccess,
                        // Tainted canvas
