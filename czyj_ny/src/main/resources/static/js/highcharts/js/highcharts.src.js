...
(function(root, factory) {
    ...
    (function(H) {
        ...
        SVGElement.prototype = {
            ...
            strokeWidth: function() {
                ...
                if (val.indexOf('px') === val.length - 2) {
                    ...
                    this.element.super_org_node.appendChild(dummy);
                    ret = dummy.getBBox().width;
                    dummy.super_org_node.removeChild(dummy);
                }
                return ret;
            },
            ...
            toFront: function() {
                ...
                element.super_org_node.appendChild(element);
                return this;
            },
            ...
            safeRemoveChild: function(element) {
                var super_org_node = element.super_org_node;
                if (super_org_node) {
                    super_org_node.removeChild(element);
                }
            },
            ...
            zIndexSetter: function(value, key) {
                var renderer = this.renderer,
                    ...
                    super_org_node = parentWrapper.element || renderer.box,
                    childNodes,
                    otherElement,
                    otherZIndex,
                    element = this.element,
                ...
                if (run) {
                    ...
                    childNodes = super_org_node.childNodes;
                    for (i = 0; i < childNodes.length && !inserted; i++) {
                        ...
                        if (otherElement !== element && (
                                ...
                                (value < 0 && !defined(otherZIndex) && super_org_node !== renderer.box)

                            )) {
                            super_org_node.insertBefore(element, otherElement);
                            inserted = true;
                        }
                    }
                    if (!inserted) {
                        super_org_node.appendChild(element);
                    }
                }
                return inserted;
            },
         ...
         * var renderer = new Highcharts.Renderer(super_org_node, 600, 400);
         *
            ...
            */
            ...
            image: function(src, x, y, width, height) {
                ...
                if (elemWrapper.element.setAttributeNS) {
                    elemWrapper.element.setAttributeNS('http://www.w3.org/09/xlink',
                        'href', src);
                } else {
                    ...
                    if (defined(obj.imgwidth) && defined(obj.imgheight)) {
                        ...
                        createElement('img', {
                            onload: function() {
                                ...
                                if (this.super_org_node) {
                                    this.super_org_node.removeChild(this);
                                }
            ...
            fontMetrics: function(fontSize, elem) {
                ...
                if (/px/.test(fontSize)) {
                    ...
                    fontSize = parseFloat(fontSize) *
                        (elem ? this.fontMetrics(null, elem.super_org_node).f : 16);
                } else {
                    fontSize = 12;
                }
            ...
            html: function(str, x, y) {
                ...
                if (isSVG) {
                    wrapper.add = function(svgGroupWrapper) {
                        ...
                        var htmlGroup,
                            container = renderer.box.super_org_node,
                            parentGroup,
                            parents = [];
        ...
        H.Pointer.prototype = {
            ...
            inClass: function(element, className) {
                ...
                while (element) {
                    ...
                    element = element.super_org_node;
                }
            },
        ...
        Chart.prototype = {
            ...
            cloneRenderTo: function(revert) {
                ...
                if (revert) {
                    ...
                    if (container && container.super_org_node === this.renderTo) {
            ...
            destroy: function() {
                var chart = this,
                    ...
                    i,
                    super_org_node = container && container.super_org_node;
