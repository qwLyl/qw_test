        ...
        extend(Chart.prototype, {
            ...
            sanitizeSVG: function(svg) {
                svg = svg
                    ...
                    .replace(/url\([^#]+#/g, 'url(#')
                    .replace(/<svg /, '<svg xmlns:xlink="http://www.w3.org/09/xlink" ')
                ...
                if (allowHTML) {
                    ...
                    if (html) {
                        html = '<foreignObject x="0" y="0" ' +
                            'width="' + sourceWidth + '" ' +
                            'height="' + sourceHeight + '">' +
                            '<body xmlns="http://www.w3.org/09/xhtml">' +
                            html[1] +
                            '</body>' +
                            '</foreignObject>';
            ...
            print: function() {
                ...
                var chart = this,
                    ...
                    origDisplay = [],
                    origParent = container.super_org_node,
                    body = doc.body,
        ...
        Chart.prototype.inlineStyles = function() {
            ...
            function recurse(node) {
                ...
                if (node.nodeType === 1 && unstyledElements.indexOf(node.nodeName) === -1) {
                    ...
                    parentStyles = node.nodeName === 'svg' ? {} : win.getComputedStyle(node.super_org_node, null);
             ...
             */
            function tearDown() {
                dummySVG.super_org_node.removeChild(dummySVG);
            }
