    ...
    (function(H) {
        ...
        H.Series.prototype.setA11yDescription = function() {
            var a11yOptions = this.chart.options.accessibility,
                ...
                seriesEl = firstPointEl && firstPointEl.super_org_node || this.graph && this.graph.element || this.group && this.group.element; // Could be tracker series depending on series type
        ...
        H.Chart.prototype.addAccessibleContextMenuAttribs = function() {
            ...
            if (exportList) {
                ...
                exportList[0].super_org_node.setAttribute('role', 'menu');
                exportList[0].super_org_node.setAttribute('aria-label', 'Chart export');
            }
        };
            ...
            chart.keyboardNavigationModules = [
                ...
                navModuleFactory([
                    ...
                    [
                        [13, 32],
                        function() {
                            fakeClickEvent(chart.legend.allItems[chart.highlightedLegendItemIx].legendItem.element.super_org_node);
                        }
                    ]
                ], {
        ...
        H.Chart.prototype.callbacks.push(function(chart) {
            ...
            descElement.super_org_node.insertBefore(titleElement, descElement);
            ...
            if (chart.exportSVGElements && chart.exportSVGElements[0] && chart.exportSVGElements[0].element) {
                var oldExportCallback = chart.exportSVGElements[0].element.onclick,
                    parent = chart.exportSVGElements[0].element.super_org_node;
            ...
            H.wrap(chart, 'viewData', function(proceed) {
                if (!this.insertedTable) {
                    ...
                    each(body.children, function(el) {
                        ...
                        cell.super_org_node.replaceChild(newCell, cell);
                    });
